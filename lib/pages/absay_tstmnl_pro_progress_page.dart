...
class _SetListData extends StatelessWidget {
  ...
  List<ResponseAbsayTstmnlDataProject> project = [];

  _SetListData(this.absayData, this.project);
      ...
      children: [
        ...
        CarouselSlider.builder(
          ...
          itemBuilder:
            ...
            child: InkWell(
              onTap: () {
                MyFunctions.showToast("Your ProjectID"+project[itemIndex].projectId.toString());
              },
              child: Image.network(project[itemIndex].image.toString()),
            ),
          ),
